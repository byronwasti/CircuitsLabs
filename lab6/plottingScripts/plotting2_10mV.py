...
def plot():
    ...
    plt.title("nMOS Series and Parallel Characteristic for 10mV Drain")
    plt.legend()
    plt.show()

if __name__ == "__main__":
    vgate_single, ichannel_single = getData("../data/experiment2_single_transistor_10mv_1.csv")
    vgate_parallel, ichannel_parallel = getData("../data/experiment2_parallel_transistor_10mv_1.csv")
    vgate_series, ichannel_series = getData("../data/experiment2_series_transistor_10mv_1.csv")
